    ...
    return (
        <div id="textblock">
            ...
            <div id="textblock-container">
                ...
                <img src={require('../images/cars.png')} className='center' style={{ width: '70%', marginTop: '20px', borderRadius: '25px'}} />
                ...
                <br></br>
                <img src={require('../images/teams.png')} className='center' style={{ width: '70%', marginTop: '20px', borderRadius: '25px' }} />
                <p className="textblock-content">
                ...
                <img src={require('../images/bluework.png')} className='center' style={{ width: '70%', marginTop: '20px', borderRadius: '25px'}} />
