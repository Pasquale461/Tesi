...
export const Dustbin = function Dustbin({level}) {
  ...
  switch (level)
  {
    case '1':
      ...
      return (
        <div id='levels'>
        <img src={require('../images/livello2.png')} id='imagelayers' ref={drop} data-testid="dustbin"/>
      ...
      return (
        <div id='levels'>
        <img src={require('../images/livello3.png')} id='imagelayers' ref={drop} data-testid="dustbin"/>
        <h1 className='texthide'>{isActive ? 'Release to drop' : 'Drag item in layer'}</h1>        </div>
      ...
      return (
        <div id='levels'>
        <img src={require('../images/livello4.png')} id='imagelayers' ref={drop} data-testid="dustbin"/>
        <h1 className='texthide'>{isActive ? 'Release to drop' : 'Drag item in layer'}</h1>        </div>
