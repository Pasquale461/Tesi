...
return (
        ...
        <h1 class="title">DATA FLOODING</h1>
        <div class="kill-chain-phase">
            <h2>1. Reconnaissance (Ricerca)</h2>

<svg width="10%" height="8%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<rect width="24" height="24" fill="white"/>
            ...
            <p>L'attaccante inizia identificando l'infrastruttura stradale, inclusi incroci, semafori, sensori di traffico che compongono il sistema di gestione del traffico. Questa mappatura è cruciale per comprendere come il traffico è regolato all'interno della città.
Cerca informazioni sulle comunicazioni di rete utilizzate dal sistema di gestione del traffico e individua le interfacce software e le applicazioni coinvolte nella gestione del traffico, come i server di controllo dei semafori, i database di configurazione e le applicazioni di monitoraggio.</p>
        </div>
        <div class="kill-chain-phase">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M19 21C19 21.5523 18.5523 22 18 22H14H10H6C5.44771 22 5 21.5523 5 21V18.75C5 17.7835 4.2165 17 3.25 17C2.55964 17 2 16.4404 2 15.75V11C2 5.47715 6.47715 1 12 1C17.5228 1 22 5.47715 22 11V15.75C22 16.4404 21.4404 17 20.75 17C19.7835 17 19 17.7835 19 18.75V21ZM17 20V18.75C17 16.9358 18.2883 15.4225 20 15.075V11C20 6.58172 16.4183 3 12 3C7.58172 3 4 6.58172 4 11V15.075C5.71168 15.4225 7 16.9358 7 18.75V20H9V18C9 17.4477 9.44771 17 10 17C10.5523 17 11 17.4477 11 18V20H13V18C13 17.4477 13.4477 17 14 17C14.5523 17 15 17.4477 15 18V20H17ZM11 12.5C11 13.8807 8.63228 15 7.25248 15C5.98469 15 5.99206 14.055 6.00161 12.8306V12.8305C6.00245 12.7224 6.00331 12.6121 6.00331 12.5C6.00331 11.1193 7.12186 10 8.50166 10C9.88145 10 11 11.1193 11 12.5ZM17.9984 12.8306C17.9975 12.7224 17.9967 12.6121 17.9967 12.5C17.9967 11.1193 16.8781 10 15.4983 10C14.1185 10 13 11.1193 13 12.5C13 13.8807 15.3677 15 16.7475 15C18.0153 15 18.0079 14.055 17.9984 12.8306Z" fill="#000000"/>
            ...
            <p>L'attaccante seleziona obiettivi specifici all'interno del sistema e considera le possibili vulnerabilità o debolezze all'interno dei bersagli selezionati. Pianifica invio di comandi di controllo errati ai semafori, la saturazione di un'area specifica con dati falsi.</p>
        </div>
        <div class="kill-chain-phase">
            <h2>3. Delivery (Consegna)</h2>
            
            <svg width="8%" height="8%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10.5 8.00012L13.5 11.0001M13.5 8.00012L10.5 11.0001M3.02832 10.0001L10.2246 14.8167C10.8661 15.2444 11.1869 15.4582 11.5336 15.5413C11.8399 15.6147 12.1593 15.6147 12.4657 15.5413C12.8124 15.4582 13.1332 15.2444 13.7747 14.8167L20.971 10.0001M10.2981 4.06892L4.49814 7.71139C3.95121 8.05487 3.67775 8.2266 3.4794 8.45876C3.30385 8.66424 3.17176 8.90317 3.09111 9.16112C3 9.45256 3 9.77548 3 10.4213V16.8001C3 17.9202 3 18.4803 3.21799 18.9081C3.40973 19.2844 3.71569 19.5904 4.09202 19.7821C4.51984 20.0001 5.0799 20.0001 6.2 20.0001H17.8C18.9201 20.0001 19.4802 20.0001 19.908 19.7821C20.2843 19.5904 20.5903 19.2844 20.782 18.9081C21 18.4803 21 17.9202 21 16.8001V10.4213C21 9.77548 21 9.45256 20.9089 9.16112C20.8282 8.90317 20.6962 8.66424 20.5206 8.45876C20.3223 8.2266 20.0488 8.05487 19.5019 7.71139L13.7019 4.06891C13.0846 3.68129 12.776 3.48747 12.4449 3.41192C12.152 3.34512 11.848 3.34512 11.5551 3.41192C11.224 3.48747 10.9154 3.68129 10.2981 4.06892Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>


            <p>L'attaccante sviluppa comandi falsificati che sembrano provenire dalla fonte legittima. Questi comandi potrebbero includere richieste di modifica dei tempi dei semafori, delle priorità del traffico o delle regole di precedenza stradale. L'obiettivo è fare in modo che i comandi falsificati siano difficili da distinguere dalle comunicazioni legittime tra il sistema di controllo del traffico e i semafori. Quindi possono essere progettate strategie per farli sembrare plausibili rispetto alle condizioni di traffico reali.</p>
        </div>
        ...
        <div class="kill-chain-phase">
            ...
            <p>L'attaccante determina la comunicazione wireless attraverso il quale invierà i comandi falsificati ai dispositivi del sistema di gestione del traffico . Una volta che tutto è pronto avvia l'inondazione di comandi falsificati.</p>
        </div>
        <div class="kill-chain-phase">
...
<path d="M17 17H17.01M17.4 14H18C18.9319 14 19.3978 14 19.7654 14.1522C20.2554 14.3552 20.6448 14.7446 20.8478 15.2346C21 15.6022 21 16.0681 21 17C21 17.9319 21 18.3978 20.8478 18.7654C20.6448 19.2554 20.2554 19.6448 19.7654 19.8478C19.3978 20 18.9319 20 18 20H6C5.06812 20 4.60218 20 4.23463 19.8478C3.74458 19.6448 3.35523 19.2554 3.15224 18.7654C3 18.3978 3 17.9319 3 17C3 16.0681 3 15.6022 3.15224 15.2346C3.35523 14.7446 3.74458 14.3552 4.23463 14.1522C4.60218 14 5.06812 14 6 14H6.6M12 15V4M12 15L9 12M12 15L15 12" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <p>L'attaccante osserva gli effetti dei comandi falsificati sulle condizioni del traffico. Monitora attentamente le conseguenze dell'attacco. Se l'attacco riesce nell'alterare il sistema di gestione del traffico in modo significativo, il traffico stradale potrebbe disgregarsi, causando caos, congestioni e rischi per la sicurezza stradale.</p>
            <img src={require('../../images/traffic.jpg')}/> 
        </div>
        <div class="kill-chain-phase">
    ...
    <g id="icons_Q2" data-name="icons Q2">
      <g>
        ...
        <path d="M44,38H4a2,2,0,0,0,0,4H44a2,2,0,0,0,0-4Z"/>
            ...
            <p>Per evitare la rilevazione, l'attaccante può variare le tattiche utilizzate durante l'attacco. Potrebbe modificare i tipi di comandi falsificati inviati o la frequenza con cui vengono inviati. Mantiene un accesso persistente al sistema di gestione del traffico, in modo da poter lanciare futuri attacchi o influenzare il traffico stradale secondo necessità. Interferendo con i sistemi di rilevamento di anomalie va ad ostacolare le contromisure intraprese dalle autorità.</p>
        </div>
        <div class="kill-chain-phase">
            <h2>7. Actions on Objectives (Azioni sugli Obiettivi)</h2>

            <svg width="8%" height="8%" viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M12.7002 17.1099V18.21C12.7002 18.3877 12.6296 18.5582 12.504 18.6838C12.3783 18.8095 12.2079 18.8799 12.0302 18.8799C11.8525 18.8799 11.6821 18.8095 11.5565 18.6838C11.4308 18.5582 11.3602 18.3877 11.3602 18.21V17.0801C10.9165 17.0072 10.4917 16.8468 10.1106 16.6082C9.72943 16.3695 9.39958 16.0573 9.14023 15.6899C9.04577 15.57 8.99311 15.4226 8.99023 15.27C8.99014 15.1834 9.00762 15.0975 9.04164 15.0178C9.07566 14.9382 9.12551 14.8662 9.18816 14.8064C9.2508 14.7466 9.32494 14.7 9.40608 14.6697C9.48723 14.6393 9.5737 14.6258 9.66023 14.6299C9.74611 14.6294 9.83102 14.648 9.90884 14.6843C9.98667 14.7206 10.0554 14.774 10.1102 14.8401C10.4301 15.258 10.8643 15.574 11.3602 15.75V13.21C10.0302 12.69 9.36023 11.9099 9.36023 10.8999C9.38027 10.3592 9.59279 9.84343 9.95949 9.44556C10.3262 9.04769 10.8229 8.79397 11.3602 8.72998V7.62988C11.3602 7.45219 11.4308 7.2819 11.5565 7.15625C11.6821 7.0306 11.8525 6.95996 12.0302 6.95996C12.2079 6.95996 12.3783 7.0306 12.504 7.15625C12.6296 7.2819 12.7002 7.45219 12.7002 7.62988V8.71997C13.0723 8.77828 13.4289 8.91103 13.7485 9.11035C14.0681 9.30967 14.3442 9.57137 14.5602 9.87988C14.6555 9.99235 14.7117 10.1329 14.7202 10.28C14.7229 10.3657 14.7083 10.451 14.6774 10.531C14.6464 10.611 14.5997 10.684 14.54 10.7456C14.4803 10.8072 14.4088 10.856 14.3298 10.8894C14.2509 10.9228 14.166 10.94 14.0802 10.9399C13.9906 10.9394 13.9022 10.9196 13.8211 10.8816C13.74 10.8436 13.668 10.7884 13.6102 10.72C13.3718 10.4221 13.0574 10.1942 12.7002 10.0601V12.3101L12.9502 12.4099C14.2202 12.9099 15.0102 13.63 15.0102 14.77C14.9954 15.3808 14.7481 15.9629 14.3189 16.3977C13.8897 16.8325 13.3108 17.0871 12.7002 17.1099ZM11.3602 11.73V10.0999C11.1988 10.1584 11.0599 10.2662 10.963 10.408C10.8662 10.5497 10.8162 10.7183 10.8202 10.8899C10.8185 11.0673 10.8688 11.2414 10.9647 11.3906C11.0607 11.5399 11.1981 11.6579 11.3602 11.73ZM13.5502 14.8C13.5502 14.32 13.2202 14.03 12.7002 13.8V15.8C12.9387 15.7639 13.156 15.6427 13.3122 15.459C13.4684 15.2752 13.553 15.0412 13.5502 14.8Z" fill="#000000"/>
            ...
            <p>Valuta se gli obiettivi dell'attacco sono stati raggiunti, se sono state create congestioni stradali o se il flusso del traffico è stato disturbato con successo. L'attaccante potrebbe cercare di sfruttare l'attacco per richiedere un riscatto o ottenere un vantaggio finanziario dalle autorità locali o dalle aziende coinvolte nella gestione del traffico.</p>
        </div>
        </div>
);
